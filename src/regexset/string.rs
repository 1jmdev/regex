...
///
/// `RegexSetBuilder` lets you construct a set of regexes while setting options
/// before compilation. Options that are not supported by this engine are
/// accepted for API compatibility and leave matching behavior unchanged.
///
/// ## Example
///
/// ```
